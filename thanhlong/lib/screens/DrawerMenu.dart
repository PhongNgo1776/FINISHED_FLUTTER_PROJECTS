    ...
    return Theme(
          ...
          children: <Widget> [
            ...
            new ListTile(
              title: Row(
                children: <Widget>[
                  Icon(Icons.movie, color: Colors.greenAccent),
                  new Text('  Danh sách phim', style: TextStyle(color: Colors.greenAccent, fontWeight: FontWeight.bold)),
                ] 
              ),
              onTap: () {
            ...
            new ListTile(
              title: Row(
                children: <Widget>[
                  Icon(Icons.close, color: Colors.redAccent[700]),

...
class MyAppState extends State<MyApp> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.network('https://phongngo1776.github.io/Videos/SwanSong/SwanSong.mp4')
    ..addListener(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Dua Lipa - Swan Song', style: TextStyle(color: Color.fromRGBO(210, 255, 77, 1)),),
